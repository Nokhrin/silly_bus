...
- объяснить связь `ссылки на объект` и `vtable`
...
- читай посты и комментарии о [типизации с подсказками](https://www.reddit.com/r/Python/comments/10zdidm/why_type_hinting_sucks/)
