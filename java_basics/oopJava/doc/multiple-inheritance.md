...
> нет - в groove совмещенная типизация, разберись и распиши
...
> в JS нет наследования, разберись
> Там нет наследования как в Java, там условная vtable, может меняться в любой момент времени,и ✓table не связана с классом, только с объектом
