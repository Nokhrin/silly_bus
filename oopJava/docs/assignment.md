...
[Диаграмма классов](uml/class-diagram-financial-entities.md)
[Диаграмма состояний - реализация](uml/state-diagram-financial-entities.md)
...
- гарантируется, что каждая операция содержит только один публичный метод
  ...
  - нельзя жестко привязать "если операция - экземпляр класса FinancialOperationsDraft.Deposit, то выполнять метод performDeposit"
