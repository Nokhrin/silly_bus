...
в java: Integer - вид рода Number 
то есть,  Integer - подтип Number
...
видовое отличие - методы класса Integer, структура данных
 ...
 типы S находятся в отношении подтипирования к типам T тогда и только тогда, когда множество значений типа S является подмножеством значений типа T
...
тогда четные целые входят в множество целых
и
...
множества могут быть вложены, но но при этом не быть в отношении подтипирования
это свойство вызваноя явлением мутабельности
...
подтипирование отвечает на вопрос - может ли s быть записан там, где ожидается t?

или, можно ли выполнить подстановку s вместо t?
