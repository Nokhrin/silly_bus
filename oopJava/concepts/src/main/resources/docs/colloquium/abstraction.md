...
### пример
[площадь фигур](../../../java/org/example/polymorphism/shapes/ShapeMain.java)  
...
[интерфейс не предоставляет расчет периметра](../../../java/org/example/polymorphism/shapes/IShapeCalculator.java)
