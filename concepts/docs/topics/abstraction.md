...
### пример
[площадь фигур](../../src/main/java/org/example/polymorphism/shapes/ShapeMain.java)  
...
[интерфейс не предоставляет расчет периметра](../../src/main/java/org/example/polymorphism/shapes/IShapeCalculator.java)
