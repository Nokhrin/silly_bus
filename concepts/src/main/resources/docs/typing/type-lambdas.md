...
[анонимный класс vs лямбда выражение](../../../java/org/example/oop_modeling/AnonymAndLambda.java)  
...
### Пример: [функция факториала](../../../java/org/example/oop_modeling/LambdasBasics.java#L87)  
...
[функциональный интерфейс - пример](../../../java/org/example/oop_modeling/IIntegerAction.java)  
значение переменной - лямбда-выражение - обязано содержать параметры и возвращаемое значение типов, указанных в интерфейсе  
  
[Лямбда - базовые операции - пример](../../../java/org/example/oop_modeling/LambdasBasics.java)  
...
[Лямбда <- существующий метод](../../../java/org/example/oop_modeling/LambdasBasics.java#L77)  
  
`Class::instanceMethod` - метод экземпляра, контекст конкретного экземпляра, первый параметр: класс-получатель  

[Лямбда <- пример `String::length`](../../../java/org/example/oop_modeling/LambdasBasics.java#L107)  
