...
import com.nokhrin.interpreter.listeners.PropFileListener;
import com.nokhrin.interpreter.listeners.PropFileListenerTest;
...
public class PropFileVisitorTest {
  private static final Logger LOGGER = LoggerFactory.getLogger(PropFileVisitorTest.class);
