...
public class LogicalOperations {
    ...
    public static ExprValue or(ExprValue left, ExprValue right) {
    ...
    public static ExprValue and(ExprValue left, ExprValue right) {
        if (left instanceof BoolValue(boolean leftValue)
                && right instanceof BoolValue(boolean rightValue)) {
            return new BoolValue(leftValue && rightValue);
        }
    ...
    public static ExprValue not(ExprValue operand) {
    ...
    public static boolean equals(ExprValue left, ExprValue right) {
    ...
    public static ExprValue compare(ExprValue left, String op, ExprValue right) {
    ...
    public static boolean compareNumeric(
            ExprValue left, ExprValue right,
